<?php
   ...
   $sqlExpiringMembers = "
       ...
       FROM members 
       WHERE DATEDIFF(ExpiryDate, CURDATE()) <= 5 AND DATEDIFF(ExpiryDate, CURDATE()) >= 0";
         ...
         <div class="p-6">
            ...
            <div class="grid grid-cols-4 gap-4">
               <div class="bg-white shadow rounded items-center">
                  ...
                  <i class="fas fa-users text-red-700 text-2xl"></i>
                  </a>
               </div>
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  ...
                  <i class="fas fa-calendar-alt text-red-700 text-2xl"></i>
               </div>
               <!-- Half-Yearly Members -->
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  <div>
                  ...
                  <i class="fas fa-calendar text-red-700 text-2xl"></i>
               </div>
               <!-- Quarterly Members -->
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  <div>
                  ...
                  <i class="fas fa-calendar-week text-red-700 text-2xl"></i>
               </div>
               <!-- Monthly Members -->
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  <div>
                  ...
                  <i class="fas fa-calendar-day text-red-700 text-2xl"></i>
               </div>
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  <div>
                  ...
                  <i class="fas fa-user-check text-red-700 text-2xl"></i>
               </div>
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  <div>
                  ...
                  <i class="fas fa-user-slash text-red-700 text-2xl"></i>
               </div>
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  <div>
                  ...
                  <i class="fas fa-user-clock text-red-700 text-2xl"></i>
               </div>
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  <div>
                  ...
                  <i class="fas fa-male text-red-700 text-2xl"></i>
               </div>
               ...
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  ...
                  <i class="fas fa-genderless text-red-700 text-2xl"></i>
               </div>
               ...
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  ...
                  <i class="fas fa-female text-red-700 text-2xl"></i>
               </div>
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  <div>
                  ...
                  <i class="fas fa-wallet text-red-700 text-2xl"></i>
               </div>
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  <div>
                  ...
                  <i class="fas fa-hand-holding-usd text-red-700 text-2xl"></i>
               </div>
               <div class="bg-white p-4 shadow rounded flex justify-between items-center">
                  <div>
                  ...
                  <i class="fas fa-money-bill-wave text-red-700 text-2xl"></i>
               </div>
                  ...
                  <div class="bg-white p-4 shadow rounded">
                     ...
                     <div class="mt-4">
                        <div class="flex justify-between items-center">
                           ...
                           <i class="fas fa-comment-dots text-red-700"></i>
                        </div>
                     </div>
                     <div class="mt-2">
                        <div class="flex justify-between items-center">
